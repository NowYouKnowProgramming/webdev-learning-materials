...
- [Web Dev Simplified - How To Create/Use Functions - JavaScript Essentials](https://www.youtube.com/watch?v=FOD408a0EzU)
- [Web Dev Simplified - Learn JavaScript Hoisting In 5 Minutes](https://www.youtube.com/watch?v=EvfRXyKa_GI)
- [Web Dev Simplified - how type coercion works](https://www.youtube.com/watch?v=GKJh3vdat8A)
- [Web Dev Simplified - Learn JavaScript Scoping In 10 Minutes](https://www.youtube.com/watch?v=TkFN6e9ZDMw)
- [Web Dev Simplified - learn about the Strict Mode and why it exists](https://www.youtube.com/watch?v=G9QTBS2x8U4)
- [Web Dev Simplified - Learn Switch Statements In 7 Minutes](https://www.youtube.com/watch?v=2gE2K8i5tvs)
- [TomDoesTech - Learn Recursion With JavaScript](https://www.youtube.com/watch?v=1JsTThBKMOc)
...
- [JavaScript's Array Explorer](https://sdras.github.io/array-explorer/)

### Core concepts in Polish

- [Jak zacząć programować? - Referencja, mutowalność, typy prymitywne](https://www.youtube.com/watch?v=-mbiJ2it-5M)
- [Jak zacząć programować? - Instrukcje warunkowe, operatory logiczne, falsy values i ternary operator](https://www.youtube.com/watch?v=vVOJ8cuFSLY)
- [Jak zacząć programować? - Destructuring i rest property w Javascript ❤️](https://www.youtube.com/watch?v=bygf54HllIQ)
...
- [TomDoesTech - JavaScript Values Vs References](https://www.youtube.com/watch?v=6Mbq-ILOlt4)
- [Josh W. Comeau - The “const” Deception](https://www.joshwcomeau.com/javascript/the-const-deception/)

### Debugging

- [Redd - Debugging Like A Pro-xy](https://redd.one/blog/debugging-like-a-pro-xy)
- [James Q Quick - Tips and Tricks for Debugging JavaScript](https://www.youtube.com/watch?v=_QtUGdaCb1c)

### JavaScript APIs

- [Web Dev Simplified - Learn Resize Observer (better than Media Queries?)](https://www.youtube.com/watch?v=M2c37drnnOA)
- [Web Dev Simplified - Learn Intersection Observer In 15 Minutes](https://www.youtube.com/watch?v=2IbRtjez6ag)
- [Web Dev Simplified - Learn Mutation Observer in 10 Minutes](https://www.youtube.com/watch?v=Mi4EF9K87aM)
- [Web Dev Simplified - Learn Temporal API in 17 Minutes](https://www.youtube.com/watch?v=oOK3UzLJ_Cs)
- [Web Dev Simplified - Learn Touch Events in 17 Minutes](https://www.youtube.com/watch?v=TaPdgj8mucI)
- [Web Dev Simplified - Learn Custom Events](https://www.youtube.com/watch?v=DzZXRvk3EGg)
- [Web Dev Simplified - Learn Push Notifications API](https://www.youtube.com/watch?v=Bm0JjR4kP8w)
- [Web Dev Simplified - Formatting Is So Easy With The Intl JavaScript API](https://www.youtube.com/watch?v=4oGWpTAY_hc)
- [Beyond Fireship - Learn Web Workers to load code in parallel](https://www.youtube.com/watch?v=-JE8P2TiJEg)

## Common patterns

- [Web Dev Simplified - Learn Debounce And Throttle In 16 Minutes](https://www.youtube.com/watch?v=cjIswDCKgu0)
- [TomDoesTech - Higher Order Functions - Design Patterns in JavaScript](https://www.youtube.com/watch?v=KSKVYNa5zJ0)
- [TomDoesTech - Facade Pattern - Design Patterns in JavaScript](https://www.youtube.com/watch?v=uuFYf0kRQBc)
- [TomDoesTech - Singleton Pattern - Design Patterns in JavaScript](https://www.youtube.com/watch?v=bQlYqOg8088)
- [TomDoesTech - Dependency Injection - Design Patterns in JavaScript](https://www.youtube.com/watch?v=W-Szy00-g_8)
