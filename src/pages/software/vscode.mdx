...
description: Visual Studio Code materials. Productivity tips, useful extensions and templates
...
- [Official article about basics of integrated terminal](https://code.visualstudio.com/docs/terminal/basics)
...
[VS Marketplace Link](https://marketplace.visualstudio.com/items?itemName=YuTengjing.better-colorizer)
...
import {
	configForGitMessageExtenstion,
	confingTemplateMessage,
} from '../../data/vscode.data.ts'

<details>
	<summary>View our template for Git Commit Message extension</summary>
	<p>Git commit template</p>
	<pre class='astro-code'>{confingTemplateMessage}</pre>
	<p>Variables for git commit template</p>
	<pre class='astro-code'>{configForGitMessageExtenstion}</pre>
</details>
